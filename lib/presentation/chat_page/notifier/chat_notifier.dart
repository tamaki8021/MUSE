...
import 'package:hibiki_tamaki_s_application1/presentation/chat_page/models/chat_model.dart';
part 'chat_state.dart';

final chatNotifier = StateNotifierProvider<ChatNotifier, ChatState>(
  (ref) => ChatNotifier(ChatState(
    chatModelObj: ChatModel(userprofilelistItemList: [
      UserprofilelistItemModel(
          userImage2: ImageConstant.imgImage48x48, userName: "Tobey"),
      UserprofilelistItemModel(
          userImage2: ImageConstant.imgRectangle2048x48, userName: "Lauren"),
      UserprofilelistItemModel(
          userImage2: ImageConstant.imgImage1, userName: "Rueesll"),
      UserprofilelistItemModel(
          userImage2: ImageConstant.imgRectangle5248x48, userName: "Dianne"),
      UserprofilelistItemModel(
          userImage2: ImageConstant.imgRectangle23, userName: "Marvin"),
